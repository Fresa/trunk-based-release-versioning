...
git() {
    case "$@" in
        ...
        "rev-parse HEAD")
            ...
            ;;
        "log 8c72ed06a8e21b2dc2c4a5d6b769ec5686170615..e0b83ea6577431c046bcb35ba49f8630009cd83c --first-parent --pretty=format:hash: %H%nmessage: | %n %s%n%n %b%n---")
        ...
        "log e0b83ea6577431c046bcb35ba49f8630009cd83c..master --first-parent --format=format:%D, %H --simplify-by-decoration --merges")
            ...
            echo "tag: v1.2.1, 7c72ed06a8e21b2dc2c4a5d6b769ec5686170614"
            ;;
        "rev-parse 7c72ed06a8e21b2dc2c4a5d6b769ec5686170614^2")
            echo "8c72ed06a8e21b2dc2c4a5d6b769ec5686170615"
            ;;
        "log e0b83ea6577431c046bcb35ba49f8630009cd83c --first-parent --format=format:%D, %H --simplify-by-decoration")
            ...
            ;;
        "rev-list 8c72ed06a8e21b2dc2c4a5d6b769ec5686170615..e0b83ea6577431c046bcb35ba49f8630009cd83c --first-parent --count")
            echo 1
            ;;
        *)
...
test_version() {
    assertEquals "Incorrect version" "1.2.2" "$TBV_VERSION"
}
...
test_patch_version() {
    assertEquals "Incorrect patch version" "2" "$TBV_PATCH_VERSION"
}
...
test_last_release_ref() {
    assertEquals "Should have set last release ref" "7c72ed06a8e21b2dc2c4a5d6b769ec5686170614" "$TBV_LAST_RELEASE_REF"
}

test_last_version() {
    assertEquals "Should have set last version" "1.2.1" "$TBV_LAST_VERSION"
}
