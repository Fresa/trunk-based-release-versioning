...
git() {
    case "$@" in
        ...
        "rev-parse HEAD")
            ...
            ;;
        "log 7c72ed06a8e21b2dc2c4a5d6b769ec5686170609..e0b83ea6577431c046bcb35ba49f8630009cd83c --first-parent --pretty=format:hash: %H%nmessage: | %n %s%n%n %b%n---")
            cat << EOF
...
test_version() {
    assertEquals "Incorrect version" "1.3.0" "$TBV_VERSION"
}
...
test_minor_version() {
    assertEquals "Incorrect minor version" "3" "$TBV_MINOR_VERSION"
}
